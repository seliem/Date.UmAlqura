...
namespace Date.UmAlqura
{
    public static class DateUtils
    {
        ...
        private static readonly string[] allFormats ={"yyyy/MM/dd","yyyy/M/d",
            "dd/MM/yyyy","d/M/yyyy",
        ...
        private static readonly CultureInfo arCul;
        private static readonly CultureInfo enCul;
        private static readonly UmAlQuraCalendar h;
        private static readonly GregorianCalendar g;
